...
const FacultySignUp = () => {
    ...
    if (value.length === 4) {
      try {
        ...
        const response = await fetch(
          `http://${import.meta.env.localhost2}:3000/facultyRoutes/signupvalidation/validatePhoneNumberOTP`,
          {
            method: "POST",
            headers: {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      if (phone !== "") {
        ...
        const response = await fetch(
          "http://:3000/facultyRoutes/signup/SendOtpNumber",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleOTPChangeForEmail = async (event) => {
    ...
    if (value.length === 4) {
      try {
        ...
        // Make API call to verify OTP or perform desired action
        const response = await fetch(
          `http://${import.meta.env.localhost2}:3000/facultyRoutes/signupvalidation/validateEmailOTP`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleSendOTPForEmail = async (e) => {
    ...
    try {
      if (email !== "") {
        ...
        const response = await fetch(
          `http://${import.meta.env.localhost2}:3000/facultyRoutes/signup/SendOtpEmail`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleEnrollChange = async (event) => {
    ...
    if (value.length === 6) {
      ...
      try {
        ...
        const response = await fetch(
          `http://${import.meta.env.localhost2}:3000/facultyRoutes/signupvalidation`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const url = `http://${import.meta.env.localhost2}:3000/facultyRoutes/signup`;
